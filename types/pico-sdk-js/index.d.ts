...
// within the https://github.com/jt000/pico-sdk-js repository.
// 
...
declare module "pico/hardware" {
    ...
    function adc_fifo_setup(en: boolean, dreq_en: boolean, dreq_thresh: number, err_in_fifo: boolean, byte_shift: boolean): void;
    ...
    function gpio_set_irq_enabled_with_callback(gpio: number, event_mask: number, enabled: boolean, callback: gpio_irq_callback_t): void;
